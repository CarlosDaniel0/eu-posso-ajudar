...
const Form = () => {
  ...
  function addItem() {
    ...
    if (input.value != "") setList((old) => [...old, input.value]);
  }
          ...
          <form>
            ...
            <div className="grid grid-cols-5 gap-0 justify-items-center md:p-0 p-4">
              ...
              <div className="my-auto w-full grid grid-cols-1 md:col-span-3 col-span-5">
                ...
                <span className="font-light">
                  Endereço: Lorem Ipsun, nº 76, bairro Canoa Quebrada, Guaribas
                  - Pará, Brasil
                </span>
                <span className="font-light">
                  Atuação: Doação de Aliementos e Cobertores
                </span>
              </div>
              <div className="col-span-5 md:col-span-1 justify-self-start">
                <ul className="grid grid-cols-5">
                  <li>
                    <StarIcon className="w-6 md:w-4 text-blue-450" />
                  </li>
                  <li>
                    <StarIcon className="w-6 md:w-4 text-blue-450" />
                  </li>
                  ...
                  <li>
                    <StarIcon className="w-6 md:w-4 text-gray-500" />
                  </li>
                  <li>
                    <StarIcon className="w-6 md:w-4 text-gray-500" />
                  </li>
            ...
            <div className="grid grid-cols-12 gap-6">
              <Input
                ...
                extra="col-span-10"
                name="items"
                icon={<GiftIcon className="w-6 md:w-5" />}
              />
              <span
                className="mt-6 md:mt-4 rounded-full w-12 h-12 col-span-2 cursor-pointer bg-green-500 flex justify-center"
                onClick={addItem}
              >
            ...
            <ul className="md:grid md:grid-cols-3 gap-2">
              {list.map((element) => {
                return (
                  <li className="shadow p-1 rounded-full md:w-auto mt-2 border flex justify-between px-6">
                    {element}{" "}
                    <MinusCircleIcon
                      className="w-6 md:w-5 ml-2 text-red-500 cursor-pointer"
