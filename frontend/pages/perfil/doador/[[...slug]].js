...
function redirectUnsigned() {
  useEffect(() => {
      const  { pathname } = Router
      console.log(router)
      if (pathname == '/perfil/doador/[...slug]')
    ...
    <React.Fragment>
      ...
      <div className='md:grid grid-cols-12 md:my-4 gap-6'>
        ...
        <div className='md:col-span-10'>
          <div className='bg-white shadow rounded-lg mx-3 h-screen md:mx-0 md:p-8 p-4'>{''}</div> 
        </div>
      </div>
    </React.Fragment>
  )
