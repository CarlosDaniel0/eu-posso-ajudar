						...
						{/* Conteúdo Principal || Main Content */}
							...
							<div className='w-full md:inline-block float-left md:w-3/5'>
								...
								<div className='md:flex md:justify-center my-8 mx-24 md:p-8'>
										<LinkButton href='/' extras='text-red-550' center button border='red-550' color='transparent' textColor='red-550' hoverText='white' hover='red-550'>
												Contribuir
										</LinkButton>
										<LinkButton href='busca' center icon={<FaSearch className='inline-block'/>} border='transparent' button color='transparent'>
												Busca
										</LinkButton>
										{/* <Link href='/'>
